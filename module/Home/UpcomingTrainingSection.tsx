                    ...
                    {contentData && contentData.map((post: any) => (
                        <div className="flex-none mr-8">
                            <div key={post.id} className="relative max-w-xs p-6 bg-transparent border border-white text-white rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" style={{
                                ...
                                <a href={`/training/${post.title.replaceAll(' ', '-')}`} type="button" className="absolute bottom-0 mb-4 text-white bg-transparent group hover:bg-peach border-b border-white font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">
                                    Register
