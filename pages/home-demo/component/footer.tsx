    ...
    return (
        ...
        <footer className="bg-white rounded-lg shadow dark:bg-gray-900 m-4">
            <div className="w-full max-w-7xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between grid desktop:grid-cols-2 grid-cols-1 space-y-4">
                    <div>
                        <a href="/" className="flex items-center mb-4 sm:mb-0">
                            <img src="/assets/logo2.png" className="h-14 mr-3" alt="Flowbite Logo" />
                        </a>
                        <br />
                    ...
                    <div className="desktop:flex grid grid-cols-1 items-center gap-8 mb-6 text-sm text-gray-500 sm:mb-0 dark:text-gray-400">
                        <div>
                            <p className="font-medium">Jakarta Office</p>
                            <br />
                        ...
                        <div>
                            <p className="font-medium">Bandung Office</p>
                            <br />
                            <p className="text-gray">
                            Jl. Setiabudhi No. 81, Bandung, <br /> 
                            Jawa Barat, Indonesia <br />
                            Phone : (022) 203 1316, 203 5436 <br />
                            Fax : (022) 203 8090 <br />
                ...
                <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">Copyright © 2022 - PT Geoservices</span>
            </div>
        </footer>
